...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    ja: {
      ...
      splash_enter: 'ENTER',
      hero_titles: 'ZEN大学 ｜ Google AI 学生 ambassador ｜ NewsPicks アンバサダー ｜ 積水グループアンバサダー',
      ...
      work_label_role: '役割',
      work_label_scale: '規模',
      work1_title: 'Google AI 学生 ambassador',
      work1_role: '学生アンバサダー',
      work1_scale: '70名規模',
      ...
      now_4: '2026年3月から42TokyoのPiscineに参加予定',
      now_updated: '最終更新：2026年2月15日',
      links_title: 'Links',
      email_label: 'Email',
    ...
    en: {
      ...
      now_4: 'Attending 42Tokyo Piscine starting March 2026',
      now_updated: 'Last updated: Feb 15, 2026',
      links_title: 'Links',
      email_label: 'Email',
      contact_title: 'Contact',
    ...
    id: {
      ...
      now_4: 'Akan mengikuti 42Tokyo Piscine mulai Maret 2026',
      now_updated: 'Pembaruan terakhir: 15 Feb 2026',
      links_title: 'Tautan',
      email_label: 'Email',
    ...
    zh: {
      ...
      now_3: '通过AI提升学习与制作速度',
      now_4: '计划从2026年3月开始参加42Tokyo的Piscine',
      now_updated: '最后更新：2026年2月15日',
      links_title: '链接',
      email_label: '邮箱',
      contact_title: '联系',
    ...
    ko: {
      ...
      now_4: '2026년 3월부터 42Tokyo Piscine 참가 예정',
      now_updated: '최종 업데이트: 2026년 2월 15일',
      links_title: '링크',
      email_label: '이메일',
      contact_title: '문의',
